...
ROOT_URLCONF = "settings_market_place.urls"
...
WSGI_APPLICATION = "settings_market_place.wsgi.application"
...
# Default storage settings, with the staticfiles storage updated - https://docs.djangoproject.com/en/5.1/ref/settings/#std-setting-STORAGES
STORAGES = {
    "default": {
...
# Wagtail settings
WAGTAIL_SITE_NAME = "settings_market_place"
